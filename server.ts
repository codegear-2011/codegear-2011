...
`;
      ...
      // Note: @google/genai SDK can use `ai.models.generateContent`
      // We will prepare a list of messages. To provide rich context, we concatenate it or pass it in systemInstruction.
